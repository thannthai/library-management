...
public class BookController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<PageResponse<BookResponse>>> getAllBooks(BookSearchRequest searchRequest) {
        return ResponseEntity.ok(new ApiResponse<>("Books retrieved successfully", true, service.searchBooks(searchRequest)));
    }
