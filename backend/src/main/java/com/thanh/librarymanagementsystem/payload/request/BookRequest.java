...
public class BookRequest {
    ...
    @NotNull(message = "Loan fee per day is mandatory")
    @DecimalMin(value = "0.0", inclusive = true, message = "Loan fee per day cannot be negative")
    @Digits(integer = 8, fraction = 2, message = "Loan fee per day must have at most 8 integer digits and 2 decimals")
    private BigDecimal loanFeePerDay;
